...
if 'trade_datetime' not in src:
    # Find the closing brace of _trade_dict by looking for plan_id line followed by }
    # Use regex to find 'plan_id': ... then add fields before the closing brace
    ...
    if new_src != src:
        ...
        print('Lines containing plan_id:')
